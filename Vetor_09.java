...
public class Ex_09 {
	...
	public static void main(String[] Args) throws Exception {
      ...
      //Numero desmembrado : 2 5 3 1 9  
        while (true) {
			System.out.println("-------------------------------------");
			System.out.println("Informe um número com no máximo cinco algarismos");
			String num = s.next(); //25345
        	//int teste = 15319;
        	//String num = String.valueOf(teste);
			while (num.length() < 5)
				num = "0" + num;
			String extenso = " ";
			int valor = 0;
